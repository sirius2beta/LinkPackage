...
void MAVLinkProtocol::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->messageReceived((*reinterpret_cast< LinkInterface*(*)>(_a[1])),(*reinterpret_cast< const mavlink_message_t(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            using _t = void (MAVLinkProtocol::*)(LinkInterface * , const mavlink_message_t & );
...
// SIGNAL 0
void MAVLinkProtocol::messageReceived(LinkInterface * _t1, const mavlink_message_t & _t2)
{
