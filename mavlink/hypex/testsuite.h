/** @file
 *    @brief MAVLink comm protocol testsuite generated from hypex.xml
 *    @see https://mavlink.io/en/
 */
#pragma once
#ifndef HYPEX_TESTSUITE_H
#define HYPEX_TESTSUITE_H
...
static void mavlink_test_hypex(uint8_t, uint8_t, mavlink_message_t *last_msg);

static void mavlink_test_all(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    mavlink_test_ardupilotmega(system_id, component_id, last_msg);
    mavlink_test_hypex(system_id, component_id, last_msg);
}
#endif
...
static void mavlink_test_custom_legacy_wrapper(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_custom_legacy_wrapper_t packet1, packet2;
        ...
        mav_array_memcpy(packet1.payload, packet_in.payload, sizeof(uint8_t)*250);
...
static void mavlink_test_hypex(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
